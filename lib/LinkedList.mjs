/*
    ...
    - A lista encadeada é uma estrutura os dados formada por unidades
    ...
    - A qualquer momento, temos o conhecimento apenas limitado de onde
...
export class LinkedList {
    ...
    constructor() {
        ...
        this.#count = 0
        console.log({hed: this.#head, tail: this.#tail, count: this.#count})
    }
