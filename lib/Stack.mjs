/*
    ...
    - Como consequência, a pilha funciona pelo princípio LIFO (Last In, Fist Out) -
...
export class Stack {
    ...
    // A pilha está vazia (true/false) - PROPRIEDADE CALCULADA (ó getter)
    get empty() {
