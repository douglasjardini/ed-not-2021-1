...
frutas.unshift('jaboticaba') // Também pode inserir mais de um elemento
// ao mesmo tempo, p. ex.: frutas.unshift('jaboticaba', 'mexerica')
console.log(frutas)

// Inserção no meio do vetor
// Parâmetros do splice() para inserção
// 1º -> posição para inserção
// 2º nº de elementos a serem excluídos (para inserção, usa-se o 0)
// 3º em diante -> elemento(s) que será(ão) inserido(s)
frutas.splice(2, 0, 'pessego') // Inserindo na terceira posição
...
// 2º -> quantidade de elementos que serão incluídos no lugar
