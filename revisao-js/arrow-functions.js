...
// a) Não preceisa de parenteses envolvendo o parâmetro
...
function megasena() {
    // Esta função retorna um npumero aleatório entre 1 e 60
    ...
    // Math.floor -> arredondar para o menor interio (tirar as casas decimais)
...
// retornam as chaves e também a palavra return, caso ela retorno valor
const somaVet2 = vet => {
    let soma = 0
    for (let n of vet) soma += n
    return soma
